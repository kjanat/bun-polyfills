...
it(`Bun.hash()`, () => {
  ...
  expect(Bun.hash(new TextEncoder().encode("hello world"))).toBe(
    0x668d5e431c3b2573n,
  );
});
it(`Bun.hash.wyhash()`, () => {
  ...
  gcTick();
  expect(Bun.hash.wyhash(new TextEncoder().encode("hello world"))).toBe(
    0x668d5e431c3b2573n,
  );
});
it(`Bun.hash.adler32()`, () => {
  ...
  gcTick();
  expect(Bun.hash.adler32(new TextEncoder().encode("hello world"))).toBe(
    0x1a0b045d,
  );
});
it(`Bun.hash.crc32()`, () => {
  ...
  gcTick();
  expect(Bun.hash.crc32(new TextEncoder().encode("hello world"))).toBe(
    0x0d4a1185,
  );
});
it(`Bun.hash.cityHash32()`, () => {
  ...
  gcTick();
  expect(Bun.hash.cityHash32(new TextEncoder().encode("hello world"))).toBe(
    0x19a7581a,
  );
  gcTick();
});
it(`Bun.hash.cityHash64()`, () => {
  ...
  gcTick();
  expect(Bun.hash.cityHash64(new TextEncoder().encode("hello world"))).toBe(
    0xc7920bbdbecee42fn,
  );
  gcTick();
});
...
it(`Bun.hash.xxHash64()`, () => {
  ...
  expect(Bun.hash.xxHash64("", 16269921104521594740n)).toBe(
    3224619365169652240n,
  );
  gcTick();
});
it(`Bun.hash.xxHash3()`, () => {
...
it(`Bun.hash.murmur32v3()`, () => {
  ...
  gcTick();
  expect(Bun.hash.murmur32v3(new TextEncoder().encode("hello world"))).toBe(
    0x5e928f0f,
  );
});
it(`Bun.hash.murmur32v2()`, () => {
  ...
  gcTick();
  expect(Bun.hash.murmur32v2(new TextEncoder().encode("hello world"))).toBe(
    0x44a81419,
  );
});
it(`Bun.hash.murmur64v2()`, () => {
  ...
  gcTick();
  expect(Bun.hash.murmur64v2(new TextEncoder().encode("hello world"))).toBe(
    0xd3ba2368a832afcen,
  );
});
it(`Bun.hash.rapidhash()`, () => {
  ...
  gcTick();
  expect(Bun.hash.rapidhash(new TextEncoder().encode("hello world"))).toBe(
    0x58a89bdcee89c08cn,
  );
});
