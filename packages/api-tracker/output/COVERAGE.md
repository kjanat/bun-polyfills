...
Generated: 12/11/2025, 3:10:22 PM | @types/bun: 1.3.4
...
| :yellow_circle: Partial        | 26      | 6%  |
| :construction: Stub            | 0       | 0%  |
| :x: Not Started                | 415     | 92% |
| **Total**                      | **452** | -   |
...
| API                            | Status          | Notes                                               |
| ------------------------------ | --------------- | --------------------------------------------------- |
| `Bun.hash`                     | :x: Not Started | Partial - some hash algorithms could be implemented |
