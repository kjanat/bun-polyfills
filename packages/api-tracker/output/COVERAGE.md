...
| `Bun.escapeHTML`                   | :x: Not Started                |       |
| `Bun.peek`                         | :x: Not Started                |       |
...
| `Bun.deepEquals`                   | :x: Not Started                |       |
| `Bun.deepMatch`                    | :x: Not Started                |       |
| `Bun.allocUnsafe`                  | :x: Not Started                |       |
| `Bun.inspect`                      | :x: Not Started                |       |
| `Bun.color`                        | :x: Not Started                |       |
...
| API                      | Status          | Notes |
| ------------------------ | --------------- | ----- |
| `Bun.deflateSync`        | :x: Not Started |       |
| `Bun.gzipSync`           | :x: Not Started |       |
| `Bun.inflateSync`        | :x: Not Started |       |
| `Bun.gunzipSync`         | :x: Not Started |       |
